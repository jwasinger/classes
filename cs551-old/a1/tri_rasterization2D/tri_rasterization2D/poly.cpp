...
void osuColor3f_d3d (double, double, double);
void osuVertex2f_d3d (double, double);
void osuBegin_d3d (int);
void osuEnd_d3d ();
void simple_triangle_d3d ();
void abutting_triangles_d3d ();
void color_polygons_d3d ();
void wedges_d3d (double,double,double,int);
void overlapTest_d3d ();
